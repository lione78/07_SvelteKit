...
<script>
    ...
    // window 객체를 svelte에서 쓰기 위해 onMount에 window Object 넣어 줌.
    onMount(()=>{
        // 모달창 띄움.
        window.name='opener';
        ...
        function setLoginStatus() {
            ...
            document.getElementById("naverIdLogin_loginButton").innerHTML = "Logout";
            ...
            document.getElementById("gnbLogin").addEventListener('click', function (e) {
                ...
                e.preventDefault();
                naverLogin.logout();
                location.replace('/oauth/naver');       //자기 자신, 기존페이지를 새로운 페이지로 변경, 뒤로가기 안됨.
            });
        }
    });
</script>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p>
            ...
            <div id="mobile"></div>
        <!-- </p> close <p> that was already automatically closed by <div> -->
    </div>
